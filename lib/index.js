 ...
 */
exports.getListOfFeaturesName = () => featureNames.reduce((res, name) => res += ', ' + name)

/**
 * @returns Number of registered features in the feature-set
 */
exports.getNumberOfFeatures = () => featureNames.length
 ...
 */
exports.extractfeaturesRaw = inputString => featureNames.reduce((res, model) =>
